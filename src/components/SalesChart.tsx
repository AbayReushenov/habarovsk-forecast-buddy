...
export const SalesChart = ({ salesData, forecastData }: SalesChartProps) => {
  ...
  const chartData = [
      ...
      ...forecastData.map((item) => ({
          ...
          temperature: item.predicted_temp ?? undefined,
          type: 'forecast',
      })),
              ...
              {chartData.length > 0 ? (
                  <ResponsiveContainer width='100%' height={400}>
                      <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                          ...
                          <YAxis yAxisId='sales' orientation='left' stroke='#64748b' fontSize={12} />
                          <YAxis yAxisId='temp' orientation='right' stroke='#64748b' fontSize={12} />
                          <Tooltip
